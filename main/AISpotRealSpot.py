...
# Config
# ================================
ENV_PATH = "/Users/yihongdai/Desktop/project/config_real.env"
STATE_FILE = "/Users/yihongdai/Desktop/project/okex/account_state_real.json"
...
acct = AccountAPI(os.getenv("OKX_API_KEY"), os.getenv("OKX_API_SECRET"), os.getenv("OKX_PASS"), use_server_time=False,
    flag='0')   # 模拟盘必须设为 '1'
mkt = MarketAPI()
trade = TradeAPI(os.getenv("OKX_API_KEY"), os.getenv("OKX_API_SECRET"), os.getenv("OKX_PASS"),False, flag='0')
...
# def place_market_buy(symbol: str, quote_amount: float, demo: bool = False):
...
#     # 实盘:   sz 是数量（BNB）
#     if demo:
#         sz = quote_amount  # USDT 金额
#     else:
#         sz = quote_amount / price  # 买入数量
#
...
#     )
#
#     print(f"📈 BUY {symbol} {'≈' if demo else ''}{sz} ({quote_amount} USDT @ {price:.2f})")
#     return res
...
if __name__ == "__main__":
    #main()
    res = trade.place_order(instId='SOL-USDT', tdMode="cash", side="buy", ordType="market", tgtCcy='base_ccy', sz=str(0.199))
    print(res)
